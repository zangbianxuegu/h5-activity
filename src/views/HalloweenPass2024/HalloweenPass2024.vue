        ...
        <activity-modal ref="modalHelp">
          <template #content>
            ...
            >
              ...
              <p class="modal-text">
                冥龙克星*1，螃蟹恶作剧*1，糖果恶作剧*1，女巫长发试用魔法*1，枯叶斗篷试用魔法*1，枯木桌椅试用魔法*1，哥特长靴试用魔法*1，螃蟹南瓜头饰试用魔法*1，吸蟹伯爵面具礼包试用魔法*1，吸蟹伯爵斗篷礼包试用魔法*1，哥特螃蟹长袍试用魔法*1，蛛丝斗篷礼包试用魔法*1，皮皮猫装扮礼包试用魔法*1，冥龙南瓜礼包试用魔法*1，猫耳发型试用魔法*1，皮皮猫礼包试用魔法*1，恶作剧飞行扫帚礼包试用魔法*2，蛛网朋克礼包试用魔法*1，疯女巫长裙礼包试用魔法*1，巫树犄角礼包试用魔法*1，蜡烛*3，爱心*1，鬼蝠斗篷试用魔法*1，南瓜帽试用魔法*1，蛛网斗篷礼包试用魔法*1，女巫帽礼包试用魔法*1，漂浮魔法*1，璀璨之星魔法*1，元气满满魔法*1，体型重塑*2，绚丽彩虹*2
              </p>
            </section>
          </template>
        </activity-modal>
