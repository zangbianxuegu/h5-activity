  ...
  >
    ...
    <template #content>
      ...
      >
        ...
        <p class="modal-text">
          4、每个账号可投递一份稿件参与比赛，投稿作品与游戏账号一对一绑定，如果您对已投稿的作品不满意，可以删除原作品后上传新作品。请勿在征集期临近结束时进行删除重传，避免审核期限超过最终上传期限；
        </p>
        <p class="modal-text">
          5、请在保证作品的原创性的同时，务必保留您的绘制过程，以便出现争议时作为申诉证明。切勿使用联动IP、AICG或他人作品进行投稿，一经发现作品将被下架并取消参赛资格。参赛作品须为《光·遇》相关，参赛者投稿作品即视为接受本次活动的所有规则；
        </p>
        <p class="modal-text">
          6、请勿投递与活动无关的稿件内容，一经发现我们将对灌水账号进行禁止上传的处罚限制；
        </p>
        <p class="modal-text">
