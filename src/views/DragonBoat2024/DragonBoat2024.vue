  ...
  <Transition appear :name="bodyTransitionName" mode="out-in">
    <div class="season22 flex h-screen">
      <div class="season22-main">
        ...
        <Transition appear :name="mainTransitionName" mode="out-in">
          <div
            class="person-img-container bg-contain bg-center bg-no-repeat"
          ></div>
        </Transition>
        <Transition appear :name="mainTransitionName" mode="out-in">
          <div
        ...
        <activity-modal ref="modalHelp">
          <template #content>
            <p class="modal-text">
              ...
              >2024年6月8日~2024年6月14日
            </p>
            <p class="modal-text">
              <span class="font-semibold">活动内容：</span>
            </p>
            <p class="modal-text">
              1、活动期间，使用一次【击鼓行舟】道具魔法，即可领取<span
                class="text-[#ffcb4d]"
                >【击鼓行舟】道具魔法</span
              >×2；
            </p>
            <p class="modal-text">
              2、活动期间，欣赏一次【先祖行舟表演】，即可领取<span
                class="text-[#ffcb4d]"
                >传信纸船</span
              >×2；
            </p>
            <p class="modal-text">
              3、活动期间，完成一次全部每日任务，即可领取<span
                class="text-[#ffcb4d]"
                >蜡烛</span
              >×2；
            </p>
            <p class="modal-text">
              4、活动期间，累计登录三天，即可领取<span class="text-[#ffcb4d]"
                >体型重塑</span
              >×2；
            </p>
            <p class="modal-text">
...
.season22 {
  ...
  &-main {
    ...
    background-image: url('@/assets/images/dragon-boat-2024/bg.jpg');
  }
}
.header {
  position: relative;
...
.task-list {
  ...
  width: 1485px;
  height: 504px;
  background-image: url('@/assets/images/dragon-boat-2024/bottom-border.png');
}
.task-item {
  width: 257px;
  height: 302px;
...
.person-img-container {
  ...
  right: 0;
  z-index: 9999;
  background-image: url('@/assets/images/dragon-boat-2024/person.png');
}
